...
<key>CFBundleVersion</key><string>5</string><key>LSMinimumSystemVersion</key><string>12.0</string>
...
await writeFile(join(dist,`mac-tauri-${arch}-build.json`),JSON.stringify({framework:'Tauri 2 + system WebKit + Node sidecar',version:'0.12.0',revision:'mac-tauri-5',arch,signature:'ad-hoc; no Developer ID',notarized:false,realUserMacAcceptance:false,keychainSyntheticTest:true,smoke:smokeResult,bytes:bytes.length,sha256:sha,commit:process.env.GITHUB_SHA||null},null,2));
