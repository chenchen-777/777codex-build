...
export const server = http.createServer(async (request, response) => {
  ...
  try {
    ...
    if (!["index.html", "styles.css", "ui.js", "features-ui.js", "account-ui.js", "install-ui.js", "import-ui.js", "mac-ui.js", normalize("assets/777codes-logo.png")].includes(safePath)) { response.writeHead(404).end("Not found"); return; }
